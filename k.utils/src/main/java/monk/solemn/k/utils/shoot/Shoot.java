...
public class Shoot {
	...
	public Shoot(String id, String site, ShootType shootType, String title, String description, Calendar date,
			List<String> tags, int numRatings, int rating, List<Actor> actors, KUtilsImage coverImage,
			List<KUtilsImage> previewImages, String externalUrl, List<Shoot> companionShoots) {
		this.id = id;
		this.site = site;
