...
public class Shoot {
	...
	public Shoot(String site, ShootType shootType, String title, String description, Calendar date,
			List<String> tags, Rating rating, List<Actor> actors, KUtilsImage coverImage,
