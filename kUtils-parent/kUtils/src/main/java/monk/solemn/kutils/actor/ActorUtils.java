...
import monk.solemn.kutils.KUtilsApplication;
...
public class ActorUtils {
	...
	public static Actor getActorData(WebDriver driver, String fallbackName) throws SQLException {
		...
		if (actorFoundPage) {
			...
			logger.traceExit();
//			((KUtilsApplication) KUtilsApplication.get()).getActorDao().saveActor(actor);
			return actor;
		}
	...
	private static boolean imageExists(RenderedImage image, List<KUtilsImage> actorImages) {
		...
		String hash = ImageUtilitiesLow.HashImage(image);
